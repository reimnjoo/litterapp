...
const LoginAuth = ({ navigation }) => {
  ...
  const loginOwner = (user) => {
    if(email === null && password === null) {
      handleInputAlert();
    } else {
      fetch("https://sseoll.com/loginOwner.php", {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    >
      ...
      >
        <Image style={styles.ellipse} source={require('../assets/img/ellipseOwner.png')}></Image>
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.signInContainer}>
            <TouchableOpacity style={styles.signInButton} onPress={() => loginOwner("owner")}>
      ...
      <View style={styles.outerButtonContainer}>
        ...
        <TouchableOpacity style={styles.registerButton} onPress={() => {navigation.navigate("RegAuthOwner")}}>
